...
from .handleGenerateMonography import HandleGenerateMonography


class GenerateMonography(QgsProcessingAlgorithm):
    """
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        generate = HandleGenerateMonography(folder, server_ip, port, bdname, user, password)
    ...
    def shortHelpString(self):
        ...
        Para utilizar essa rotina é necessário que o LibreOffice esteja instalado no computador.
        Os parâmetros necessários para essa rotina são:
        - Pasta com a estrutura de pontos de controle OU Pasta com várias estruturas de ponto de controle
