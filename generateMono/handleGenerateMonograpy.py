...
class HandleGenerateMonograpy():
    ...
    def executeProcess(self, folder):
        ...
        pto['photoView1'] = str(Path(folder / '7_Imagens_Monografia' / '{}_MUNICIPIO.jpg'.format(pto["cod_ponto"])))
        pto['photoView2'] = str(Path(folder / '7_Imagens_Monografia' / '{}_ESTADO.jpg'.format(pto["cod_ponto"])))
